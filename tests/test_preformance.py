...
def test_large_list_assignment_optimization():
    """
    ...
    # We relax the threshold to 0.05s to account for Pydantic validation overhead.
    # Without optimization, naive deep copies or double wrapping could take > 0.1s
    assert duration < 0.05, f"Assignment took too long: {duration:.4f}s"
...
def test_repeated_attribute_access_speed():
    """
