...
class TestMutableMixinBasics:
    ...
    def test_pydantic_v2_internals_ignored(self):
...
class TestOptimizationLogic:
    ...
    def test_short_circuit_wrapping_list(self):
        """
    ...
    def test_short_circuit_wrapping_dict(self):
        """
    ...
    def test_lazy_change_detection(self):
        """
