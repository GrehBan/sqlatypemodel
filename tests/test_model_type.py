...
class TestModelTypeInit:
    ...
    def test_no_slots_defined(self):
        ...
        """
        assert "__slots__" not in ModelType.__dict__, "ModelType must not define __slots__"

    def test_sqlalchemy_clone_compatibility(self):
        """
    ...
    def test_init_without_serializers_raises(self):
...
class TestModelTypeSerialization:
    ...
    def test_process_bind_param_error(self):
        ...
        with pytest.raises(SerializationError, match="Failed to serialize"):
            model_type.process_bind_param(BadModel(value="test"), None)

    def test_process_result_value_error(self):
        ...
        with pytest.raises(DeserializationError, match="Failed to deserialize"):
            model_type.process_result_value({"invalid": "data"}, None)